...
function setupEventListeners(client) {
    ...
    client.on("message", (msg) => {
        ...
        if (playerName !== undefined) {
            ...
            logMessage((`Name: "${playerName}", Clan: "${playerClan}", Skin: "${playerSkin}", Message: "${msg.message}"`));
    
            if (msg.message.toLowerCase().includes("all-analyze")) {
        ...
        if (joinMatch) {
            ...
            logMessage(`Player entered, Name: "${playerName}"`);
        }
